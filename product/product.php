...
<div class="product-container">
    <h1 class="text-center mb-4">Gun</h1>
    <div class="row">
        <?php
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Harga: $ <?php echo number_format($harga_dollar, 2); ?></p>
                            <div class="d-flex justify-content-between">
                                ...
                                <form method="post" action="keranjang.php">
                                    ...
                                    <input type="hidden" name="product_price" value="<?php echo $harga_dollar; ?>">
